...
export const ModalContent = (props: ModalSphere) => {
  const { setObjects, objects } = useObjects();

  const letters = objects.find((obj) => obj.id === props.sphere);

  // const [radius, setRadius] = useState(letters?.radius ?? 100);
  // const [intM, setIntM] = useState(letters?.intensityM ?? 9);
  // const [intP, setIntP] = useState(letters?.intensityP ?? 9);

  // const [Ka, setKa] = useState(arrayNumberToArrayString(letters?.Ka));
  // const [Kd, setKd] = useState(arrayNumberToArrayString(letters?.Kd));
  // const [Ks, setKs] = useState(arrayNumberToArrayString(letters?.Ks));
  // const [Ns, setNs] = useState(letters?.n.toString() ?? '1');

  // const [name, setName] = useState(letters?.name ?? 'Esfera X');

  // const [x, setX] = useState(letters?.center[0].toString() ?? '0');
  // const [y, setY] = useState(letters?.center[1].toString() ?? '0');
  // const [z, setZ] = useState(letters?.center[2].toString() ?? '0');
  ...
  //           {letters !== undefined ? 'Editar' : 'Criar'} esfera
  //         </PrimaryButton>
  //       </Stack>
  //     </div>
  //   </Modal>
